...
import CV from "../../assets/CV_Le_Cong_Quoc_Duy.pdf";
    ...
    return (
        <div className="about__info grid">
            <div className="about__box">
                ...
                <h3 className="about__title">{t.about.expLabel}</h3>
                <span className="about__subtitle">{t.about.expValue}</span>
            </div>
            <div className="about__box">
                <i className="bx bx-briefcase-alt about__icon"></i>
                <h3 className="about__title">{t.about.projectLabel}</h3>
                <span className="about__subtitle">{t.about.projectValue}</span>
            </div>
            <div className="about__box">
                <i className="bx bx-support about__icon"></i>
                <h3 className="about__title">{t.about.supportLabel}</h3>
...
const About = () => {
    ...
    return (
        <section className="about section" id="about">
            <h2 className="section__title" data-aos="fade-up">{t.about.title}</h2>
            <span className="section__subtitle" data-aos="fade-up" data-aos-delay="100">{t.about.subtitle}</span>
