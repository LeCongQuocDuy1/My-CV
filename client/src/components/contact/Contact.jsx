...
function Contact() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            toast.success(c.successMsg, { duration: 5000 });
            setForm(EMPTY);
        } catch (err) {
    ...
    return (
        <section className="contact section" id="contact">
            <h2 className="section__title" data-aos="fade-up">{c.title}</h2>
            <span className="section__subtitle" data-aos="fade-up" data-aos-delay="100">{c.subtitle}</span>

            <div className="contact__container container grid">
                <div className="contact__content" data-aos="fade-right">
                    <h3 className="contact__title">{c.talkToMe}</h3>
                    ...
                    <div className="contact__info">
                        <div className="contact__card">
                            ...
                            <a href="mailto:duy9117@gmail.com" className="contact__button">
                                {c.writeMe} <i className="bx bx-right-arrow-alt contact__button-icon"></i>
                            </a>
                        </div>
                        <div className="contact__card">
                            ...
                            <a href="https://wa.me/84103244716" target="_blank" rel="noreferrer" className="contact__button">
                                {c.writeMe} <i className="bx bx-right-arrow-alt"></i>
                            </a>
                        </div>
                        <div className="contact__card">
                            ...
                            <a href="https://m.me/lequocduy1003" target="_blank" rel="noreferrer" className="contact__button">
                                {c.writeMe} <i className="bx bx-right-arrow-alt"></i>
                            </a>
                        </div>
                    </div>
                ...
                <div className="contact__content" data-aos="fade-left">
                    <h3 className="contact__title">{c.writeProject}</h3>

                    <form onSubmit={handleSubmit} className="contact__form">
                        <div className="contact__form-div">
                            <label className="contact__form-tag">{c.name}</label>
                            <input
                                type="text" name="name"
                        ...
                        <div className="contact__form-div">
                            <label className="contact__form-tag">{c.email}</label>
                            <input
                        ...
                        <div className="contact__form-div">
                            <label className="contact__form-tag">{c.subject}</label>
                            <input
                        ...
                        <div className="contact__form-div contact__form-area">
                            <label className="contact__form-tag">{c.message}</label>
                            <textarea
